 ...
 */
@RestController
@RequestMapping("/ware/taskDetail")
public class WmsWareOrderTaskDetailController extends BaseController
{
     ...
     * 查询库存工作单列表
     */
    @PreAuthorize("@ss.hasPermi('ware:taskDetail:list')")
    @GetMapping("/list")
     ...
     * 导出库存工作单列表
     */
    @PreAuthorize("@ss.hasPermi('ware:taskDetail:export')")
     ...
     * 获取库存工作单详细信息
     */
    @PreAuthorize("@ss.hasPermi('ware:taskDetail:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增库存工作单
     */
    @PreAuthorize("@ss.hasPermi('ware:taskDetail:add')")
     ...
     * 修改库存工作单
     */
    @PreAuthorize("@ss.hasPermi('ware:taskDetail:edit')")
     ...
     * 删除库存工作单
     */
    @PreAuthorize("@ss.hasPermi('ware:taskDetail:remove')")
